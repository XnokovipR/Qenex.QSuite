...
public class ProtocolVariableWrapper : PropertyChangedBase, IViewableItem
{
    ...
    public string Label
    {
        get => protocolVariable.Variable.Label;
        set { protocolVariable.Variable.Label = value; OnPropertyChanged(); }
    }

    public string ToolTip => GetToolTip();
    
    public BitmapImage Icon => ImageGetter.GetBitmapImage("Icons/SolutionExplorer/ProtocolVariable.png");
