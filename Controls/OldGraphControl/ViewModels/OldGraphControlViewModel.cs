...
namespace Qenex.QSuite.Controls.OldGraphControl.ViewModels;

public sealed class OldGraphControlViewModel : ControlBase
{
	...
	public OldGraphControlViewModel()
	{
	...
	public override string ControlName => "Old-GraphControl";
	public override string Label => "Old-Graph";
